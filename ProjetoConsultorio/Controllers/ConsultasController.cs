...
using ProjetoConsultorio.Data;
using ProjetoConsultorio.Models;

namespace ProjetoConsultorio.Controllers
{
    public class ConsultasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Sobrenome,CPF,DataNasc,Convenio,DataConsulta,Observacoes")] Consulta consulta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Sobrenome,CPF,DataNasc,Convenio,DataConsulta,Observacoes")] Consulta consulta)
        {
            if (id != consulta.Id)
            {
                return NotFound();
